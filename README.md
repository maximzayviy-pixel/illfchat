...
- ✅ **Видеозвонки** - видеозвонки 1-на-1 с камерой
- ✅ **Аудиозвонки** - обычные аудиозвонки без видео
...
- ✅ **Статистика звонков** - отслеживание количества и длительности
...
2. Нажмите кнопку видеозвонка (камера) или аудиозвонка (телефон)
3. Дождитесь подключения к комнате

### Админ-панель

1. Войдите как администратор (username: admin, email: admin@klubok.com)
2. Нажмите кнопку "Админ-панель" в правом верхнем углу
3. Просматривайте статистику звонков и управляйте пользователями
